...
export default function Content() {
  return (
    <section className="content lg:h-[60vh] flex items-center justify-center">
      <div className="container h-[40rem] lg:h-[30rem] gap-6 grid grid-cols-1 lg:grid-cols-2 py-11 my-11">
        <div className="w-full h-full rounded-[4rem] bg-slate-100 overflow-hidden relative ">
          ...
          <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 text-gray-100 lg:text-2xl text-center font-semibold z-20">
            <q >
